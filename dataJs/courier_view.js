        ...
        success: function(response) {
            try {
                ...
                if (jsonResponse.error) {
                    $(".resultados_ajax_mail").html("<div class='alert alert-danger'>" + jsonResponse.error + "</div>");
                } else {
                    $(".resultados_ajax_mail").html("<div class='alert alert-success'>" + jsonResponse.success + "</div>");
                }
            } catch (e) {
                $(".resultados_ajax_mail").html("<div class='alert alert-danger'>Error parsing response</div>");
            }
            $('#guardar_datos').attr("disabled", false);
        },
        error: function(xhr, status, error) {
            $(".resultados_ajax_mail").html("<div class='alert alert-danger'>Error: " + error + "</div>");
            $('#guardar_datos').attr("disabled", false);
        }
    });
});
