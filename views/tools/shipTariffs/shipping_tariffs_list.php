                        ...
                        <div class="card">
                            <div class="card-body"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group">
                                        <!-- Opción 1 (simple): llamar a cdp_load(1) -->
                                        <select onchange="cdp_load(1)" style="width: 100% !important;" class="select2 form-control" name="name_item" id="name_item"></select>

                                        <!-- Opción 2 (recomendada): SIN onchange y dejar que JS maneje el change -->
                                        <!-- <select style="width: 100% !important;" class="select2 form-control" name="name_item" id="name_item"></select> -->
                                      </div>
                                    </div>
