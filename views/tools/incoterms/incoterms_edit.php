...
<body>
	...
	<div id="main-wrapper">
								...
								<div class="col-12">
									<div class="card-body">
										<form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
											...
											<div class="form-group">
												<div class="col-sm-12">
													<button class="btn btn-outline-danger btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['tools-incoterms4'] ?> <span><i class="icon-ok"></i></span></button>
		...
		<script src="<?= cdp_asset('dataJs/incoterms.js') ?>"></script>
</body>
