...
<head>
    ...
    <title><?php echo $lang['asingmodule1'] ?> | <?php echo $core->site_name ?></title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><?php echo $lang['asingmodule1'] ?></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <div class="form-group">
                                                <a href="asingpermissions_add.php"><button type="button" class="btn btn-outline-danger btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['rolesp29'] ?></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 pull-right m-b-20">
                                    ...
                                    <div class="input-group input-group">
                                        ...
                                        <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="<?php echo $lang['asingmodule3'] ?>" onkeyup="cdp_load(1);">
