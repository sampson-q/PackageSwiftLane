...
<head>
    ...
    <title><?php echo $lang['rolesp10'] ?> | <?php echo $core->site_name ?></title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><span><?php echo $lang['rolesp10'] ?></span></h3>
                                    </div>
                                </div>
                                <div><hr><br></div>
                                <form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-danger btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['rolesp14'] ?> <span><i class="icon-ok"></i></span></button>
                                            <a href="permissions_list.php" class="btn btn-outline-secondary btn-confirmation"><span><i class="ti-share-alt"></i></span> <?php echo $lang['rolesp15'] ?></a>
                                        </div> 
                                    </div>
                                </form>
