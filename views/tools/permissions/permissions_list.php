...
<head>
    ...
    <title><?php echo $lang['rolesp1'] ?> | <?php echo $core->site_name ?></title>
                               ...
                               <div class="m-t-40">
                                ...
                                <div class="col-md-4 pull-right m-b-20">
                                    ...
                                    <div class="input-group input-group">
                                        ...
                                        <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="<?php echo $lang['rolesp2'] ?>" onkeyup="cdp_load(1);">
