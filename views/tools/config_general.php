				...
				<form class="form-horizontal form-material" id="save_config_general" name="save_config_general" method="post">
					...
					<section>
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="phoneNumber1"><?php echo $lang['tools-config34'] ?></label>
           							  ...
           							  <select class="select2 form-control custom-select" style="width: 100%; height:36px;" id="timezone" name="timezone">
							            <option value="<?php echo $core->timezone; ?>"><?php echo $core->timezone; ?></option>
							...
							<div class="col-md-6">
						        <div class="form-group">
						            <label for="language"><img src='assets/images/alert/lang.png' width='20' /> <?php echo $lang['tools-config62'] ?></label>
						            <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="language" id="language">
						                <optgroup label="<?php echo $lang['left393'] ?>">
						...
						<div class="row">
							...
							<div class="col-md-6">
						        <div class="form-group">
						            <label for="colaboradores"><?php echo $lang['tools-config52'] ?></label>
						            <select class="select2 form-control" style="width: 100%; height:36px;" id="colaboradores" value="<?php echo $core->currency; ?>" list="browsers12" autocomplete="off" required="required">
					...
					<div class="form-group">
						<div class="col-sm-12">
							<button type="submit" class="btn btn-danger btn-confirmation" name="dosubmit"><?php echo $lang['tools-config56'] ?> <span><i class="icon-ok"></i></span></button>
						</div>
					</div>
				</form>
			</div>
