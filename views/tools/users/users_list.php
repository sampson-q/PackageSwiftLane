...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title"><span><?php echo $lang['user_manage48'] ?></span></h3>
                                    </div>
                                </div>
                                <div><hr></div>
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <div class="form-group">
                                                <a href="users_add.php"><button type="button" class="btn btn-outline-danger btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['user_manage44'] ?></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="<?= cdp_asset('dataJs/users.js') ?>"></script>
</body>
