...
<body>
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <div class="form-group">
                                                <a href="payment_methods_add.php"><button type="button" class="btn btn-danger btn"><i class="ti-plus" aria-hidden="true"></i> <?php echo $lang['tools-methodpay15'] ?></button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="<?= cdp_asset('dataJs/payment_method.js') ?>"></script>
</body>
