...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-danger btn-confirmation" name="dosubmit" type="submit"><?php echo $lang['tools-category9'] ?> <span><i class="icon-ok"></i></span></button>
    ...
    <script src="<?= cdp_asset('dataJs/category.js') ?>"></script>
</body>
