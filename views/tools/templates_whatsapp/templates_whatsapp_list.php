								...
								<div class="col-lg-12 col-xl-12 col-md-12">
									<div class="card-body">
										...
										<div class="d-md-flex align-items-center">
						                    <div>
						                        <h3 class="card-title"><span><?php echo $lang['ws-add-text9'] ?></span></h3>
						                    </div>
						                </div>
						                <div><hr><br></div>
											...
											<div class="d-flex">
												<div class="mr-auto">
													<div class="form-group">
														<a href="templates_whatsapp_add.php">
										...
										<div class="col-md-4 pull-right m-b-20">
											...
											<div class="input-group input-group">
												...
												<input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="<?php echo $lang['ws-add-text15'] ?>" onkeyup="cdp_load(1);">
											</div>
										</div><!-- /.col -->
