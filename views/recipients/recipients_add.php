                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="save_user" name="save_user" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-danger btn-confirmation" id="save_data" name="save_data" type="submit"><?php echo $lang['add_recipient'] ?><span><i class="icon-ok"></i></span></button>
