...
<body>
	...
	<div id="main-wrapper">
											...
											<div class="d-flex">
												<div class="mr-auto">
													<div class="form-group">
														<button type="button" onclick="cdp_updateNotificationsRead();" class="btn btn-danger btn btn-sm"><i class="fa fa-check" aria-hidden="true"></i> <?php echo $lang['notification_title7'] ?></button>
													</div>
												</div>
											</div>
										</div>
		...
		<script src="<?= cdp_asset('dataJs/notifications.js') ?>"></script> 
</body>
