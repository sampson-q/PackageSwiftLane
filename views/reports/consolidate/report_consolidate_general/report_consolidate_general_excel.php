...
$sql = "SELECT a.total_weight, a.total_tax_discount, a.sub_total, a.total_tax_insurance, a.total_tax_custom_tariffis, a.total_tax,   a.total_order, a.consolidate_id, a.c_prefix, a.c_no, a.c_date, a.sender_id, a.receiver_id, a.recipient_type, a.order_courier,a.status_courier,  b.mod_style, b.color FROM cdb_consolidate as a
	...
	<html>
		...
		<tbody>
			<tr style="background-color: #3e5569; color: white">				
				...
				<th><b>' . $lang['asingreportexcell2'] . '</b></th>
				<th><b>' . $lang['asingreportexcell1'] . '</b></th>
...
if ($numrows > 0) {
	...
	foreach ($data as $row) {
		...
		$html .= '<td>' . $address_order->recipient_country . '-' . $address_order->recipient_city . '<br>'. $address_order->recipient_address .'</td>';
