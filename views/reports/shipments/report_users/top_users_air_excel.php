...
header("Content-Disposition: attachment; filename=$report_type Report - (Air Shipping) " . date('Y-m-d') . ".xls");
header("Expires: 0");
...
<head>
    <meta charset="UTF-8">
    <title><?= $lang["report-text88"] ?> – Air Shipping</title>
...
<body>
    <h2>
        ...
        <?= $lang["report-text88"] ?> – Air Shipping<br>
