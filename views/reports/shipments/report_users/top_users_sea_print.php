...
<div id="page-wrap">
    <h2 style="align-items: center; text-align: center;">
        ...
        <?php echo $lang['report-text88'] . ' - Sea Shipping' ?><br>
            ...
            <tr>
                ...
                <td>
                    <div style="max-width: 100px; word-wrap: break-word;">
                        <?php echo htmlspecialchars($tracking_purchase->tracking_number, ENT_QUOTES); ?>
                    </div>
                </td>
                <td><?php echo htmlspecialchars($row->order_date, ENT_QUOTES); ?></td>
                <td><?php echo htmlspecialchars($address_order->recipient_country . ' - ' . $address_order->recipient_city, ENT_QUOTES); ?></td>
                <td><?php echo $core->currency . ' ' . cdb_money_format($row->total_order); ?></td>
                <td><?php echo $text_status; ?></td>
                
            </tr>
            <?php $counter += 1; endforeach; endif; ?>
        </tbody>
    </table>
