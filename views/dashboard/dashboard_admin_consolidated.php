...
<body>
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate WHERE 1=1' . $agency_where);
                                                $db->cdp_execute();
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate WHERE status_courier=8' . $agency_where);
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo (int)($count ? $count->total : 0);
                                                ?>                      
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate WHERE status_invoice=2' . $agency_where);
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo (int)($count ? $count->total : 0);
                                                ?>                      
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                                <?php
                                                $db->cdp_query('SELECT COUNT(*) as total FROM cdb_consolidate WHERE status_invoice=3' . $agency_where);
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
                                                echo (int)($count ? $count->total : 0);
                                                ?>                      
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="card-info-statics">
                                              <h5 class="mb-0">
                                                ...
                                                $db->cdp_query("SELECT IFNULL(SUM(total_order), 0) as total FROM cdb_consolidate WHERE 1=1" . $agency_where);
                                                $db->cdp_execute();
                                                $count = $db->cdp_registro();
    ...
    <script src="<?= cdp_asset('dataJs/dashboard_consolidate.js') ?>"></script>