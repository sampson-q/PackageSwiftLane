...
<head>
    ...
    <title><?php echo $lang['lockersearch'] ?> | <?php echo $core->site_name ?></title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"> <?php echo $lang['lockersearch']; ?></h4>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class=" col-sm-12 col-md-4 mb-2">
                                    <div class="input-group">
                                        <input type="text" name="search" id="search" class="form-control input-sm float-right" placeholder="<?php echo $lang['left21552'] ?>" onkeyup="cdp_load(1);">
