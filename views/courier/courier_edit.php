...
<head>
    ...
    <style>
        ...
        .rate-box {background:#f8f9fa;border-radius:.5rem;padding:0.75rem 1rem;border:1px solid #e3e6ea;}
        ...
        <div class="page-wrapper">
            ...
            <form method="post" id="invoice_form" name="invoice_form" enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                    ...
                    <!-- PASO 0: Número de orden / Agencia / Oficina -->
                    <div class="row">
                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="order_no" id="order_no"
                                                   value="<?php echo htmlspecialchars($row_order->order_prefix . $row_order->order_no, ENT_QUOTES, 'UTF-8'); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div></div>
                            ...
                            <div class="card"><div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-10">
                                                <select class="select2 form-control custom-select" id="sender_id" name="sender_id" style="width:100%">
                                                    <option value="<?php echo $sender_data->id; ?>">
                                                        <?php echo htmlspecialchars($sender_data->fname . ' ' . $sender_data->lname, ENT_QUOTES, 'UTF-8'); ?>
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <select class="select2 form-control" id="sender_address_id" name="sender_address_id" style="width:100%">
                                                    <option value="<?php echo $row_order->sender_address_id; ?>">
                                                        <?php echo htmlspecialchars($address_order->sender_address ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="button" id="add_address_sender" data-type_user="user_customer" data-toggle="modal" data-target="#myModalAddUserAddresses" class="btn btn-default"><i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <select class="select2 form-control custom-select" id="recipient_id" name="recipient_id" style="width:100%">
                                                    <option value="<?php echo $receiver_data->id; ?>">
                                                        <?php echo htmlspecialchars($receiver_data->fname . ' ' . $receiver_data->lname, ENT_QUOTES, 'UTF-8'); ?>
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="button" id="add_recipient" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipient" class="btn btn-default"><i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <select class="select2 form-control" id="recipient_address_id" name="recipient_address_id" style="width:100%">
                                                    <option value="<?php echo $row_order->receiver_address_id; ?>">
                                                        <?php echo htmlspecialchars($address_order->recipient_address ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="button" id="add_address_recipient" data-type_user="user_recipient" data-toggle="modal" data-target="#myModalAddRecipientAddresses" class="btn btn-default"><i class="fa fa-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="rate-box mb-3">
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="select2 form-control custom-select" id="order_deli_time" name="order_deli_time" disabled style="width:100%">
                                                    <option value="<?php echo $delivery_times->id; ?>">
                                                        <?php echo $delivery_times->delitime; ?>
                                                    </option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="control-label col-form-label"><?php echo $lang['add-title19'] ?> <i style="color:#ff0000" class="fas fa-shipping-fast"></i></label>
                                                <div class="input-group mb-3">
                                                    <select class="custom-select col-12" id="status_courier" name="status_courier" required>
                                                        ...
                                                        <?php foreach ($statusrow as $row): ?>
                                                            <?php if (in_array($row->id, [8,11,12,13,14,15,16])) continue; ?>
                                                            <option value="<?php echo $row->id; ?>"
                                            ...
                                            <div class="col-md-3" style="display:none">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type='text' class="form-control" name="order_date" id="order_date"
                                                           value="<?php echo date('Y-m-d', strtotime($row_order->order_datetime)); ?>" readonly />
                                                </div>
                                            </div>
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table table-sm table-bordered table-hover table-packages mb-0" id="packages_table">
                                            ...
                                            <tbody>
                                                <!-- Populated by courier_edit.js loadPackages() -->
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-2">
                                            ...
                                            <button type="button" id="openMultiFile" class="btn btn-default pull-left mb-4">
                                                <i class='fa fa-paperclip' style="font-size:18px;cursor:pointer;"></i> <?php echo $lang['leftorder16']; ?>
                                            </button>
                                        </div>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div id="clean_files" class="hide">
                                            <button type="button" id="clean_file_button" class="btn btn-danger ml-3">
                                                <i class='fa fa-trash' style="font-size:18px;cursor:pointer;"></i> <?php echo $lang['leftorder17']; ?>
                                            </button>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mb-3 mt-2">
                                                        <p class="text-justify">
                                                            <a style="color:#7460ee;" target="_blank" href="<?php echo $file->url; ?>"><?php echo $file->name; ?></a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mb-2">
                                                        <button type="button" class="btn btn-danger btn-sm" onclick="cdp_deleteImgAttached('<?php echo $file->id; ?>');">
                ...
                <input type="hidden" name="recipient_type" id="recipient_type_hidden" value="<?php echo htmlspecialchars($row_order->recipient_type ?? 'recipient', ENT_QUOTES, 'UTF-8'); ?>" />
