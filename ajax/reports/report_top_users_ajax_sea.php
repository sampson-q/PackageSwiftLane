...
switch ($page) {
    case 'topshipper':
        ...
        $sql = "SELECT
                ...
                WHERE
                    ...
                    $sWhere
                GROUP BY
                    b.id, b.lname, b.fname, b.avatar, b.username, b.email,
                    b.locker, b.phone, b.created, b.lastlogin, a.sender_id
                ORDER BY
    ...
    case 'topinvoice':
        ...
        $sql = "SELECT
                    ...
                    b.lastlogin,
                    a.sender_id,
                    SUM(a.total_order) AS total_invoiced
                FROM cdb_add_order AS a
                INNER JOIN cdb_users AS b
                    ON b.id = a.sender_id
                WHERE
            ...
            <tbody id="projects-tbl">
                ...
                if (empty($shipments)) {
                    ...
                    foreach ($shipments as $row) {
                        ...
                        $db->cdp_query("SELECT * FROM cdb_package_tracking_number WHERE order_id = '" . $row->order_id . "'");
                        $tracking_purchase = $db->cdp_registro();
                        ...
                        <tr class="card-hovera">
                            <td>
                                <b>
                                    <a href="courier_view.php?id=<?php echo $row->order_id; ?>">
                                        <?php echo htmlspecialchars($row->order_prefix . $row->order_no, ENT_QUOTES); ?>
                                    </a>
                                </b>
                            </td>
                            
                            <td><?php echo htmlspecialchars($tracking_purchase->tracking_number, ENT_QUOTES); ?></td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="overflow-y: auto; max-height: 200px;">
                                        ...
                                        <a class="dropdown-item"
                                           href="courier_view.php?id=<?php echo $row->order_id; ?>">
