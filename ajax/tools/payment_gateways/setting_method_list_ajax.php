...
<div class="table-responsive">
				...
				<tr>
					...
					<td class="text-center" width="100">
						...
						<?php } else if ($row->id == 6) { ?>
							<a href="payment_mode_hubtel_edit.php?id=6" data-toggle="tooltip" data-original-title="<?php echo $lang['tools-methodpay16'] ?>"><i class="ti-pencil" aria-hidden="true"></i></a>
						<?php } ?>
					</td>
	...
	<div class="pull-right">
		...
		<?php echo cdp_paginate($page, $total_pages, $adjacents, $lang, 'setting_method_list');	?>
	</div>
</div>
<?php } ?>