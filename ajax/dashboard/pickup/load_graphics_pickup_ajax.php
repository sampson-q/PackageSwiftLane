...
// *************************************************************************
	...
	for ($month = 1; $month <= 12; $month ++){
    	...
    	$sql="SELECT IFNULL(SUM(total_order), 0) as total FROM cdb_add_order WHERE status_courier!=21 and is_pickup=1 and  month(order_date)='$month' AND year(order_date)='$year' $sWhere"; 
