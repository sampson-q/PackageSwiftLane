...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="pull-left">
            ...
            <?php 
            // Verifica si la fecha de pago no es nula
            $payment_date = $data->payment_date ? date('Y-m-d h:i A', strtotime($data->payment_date)) : '';
            ?>
            <p class="text-muted  m-l-5"><?php echo $payment_date; ?></p>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="pull-left">
            ...
            <?php 
            // Verifica si se obtuvo el resultado de la consulta para el método de pago
            $met_payment_name = $met_payment ? $met_payment->name_pay : '';
            ?>
            <p class="text-muted  m-l-5"><?php echo $met_payment_name; ?></p>
        </div>
    </div>
