...
$lang = array(
	...
	"messagesform1" 			=> "Please select at least 2 shipments to consolidate.",
	...
	"validate_field_ajax180" => "Template content is required",
	...
	"super_admin_no_delete" => "You cannot delete a Super Admin user.",
	"super_admin_edit_only" => "Only a Super Admin can edit this user.",
	"super_admin_role_no_delete" => "The Super Admin role cannot be deleted.",
	...
	"translate_search_shipmode" => "Search shipping mode",
    ...
    "left-menu-sidebar-65" => "Pickup Client",
	...
	"left-menu-sidebar-17" => "Create Multiple Shipments",
    ...
    "left-menu-sidebar-66" => "Push Notifications",
	...
	"left-menu-sidebar-64" => "Air Shipping",
	...
	"seed_user_admin" => "Administrator",
	"seed_user_employee" => "Employee",
	"seed_user_customer" => "Customer",
	"seed_user_driver" => "Driver",
	"seed_user_agency" => "Agency",
	"seed_password_label" => "Demo password for all: 09731",
	"seed_created_message" => "Demo users created.",
	"seed_no_new_users" => "No new users (already exist).",
	...
	"report-text35" => "Fr",
	"report-text36" => "Sa",
    "report-text90" => "-- Click to Select Period --",
	"report-text91" => "No shipments found for the selected period",
	"report-text92" => "Most Invoiced Account",
	"report-text93" => "Period",
	...
	"left21553" => "the postal tracking number / tracking number",
	...
	"leftorder14442" => "Random (Recommended, for added security)",
	...
	"leftorder178" => "Female",
	"leftorder179" => "Male",
	"leftorder332" => "Upload Profile Photo",
	"leftorder333" => "Upload Document Photo",


	"leftorder001791" => "Super Admin",
	"leftorder001792221" => "User level 7",
	"leftorder001792222" => "User level 6",
	"leftorder001792223" => "User level 5",
	"leftorder001792224" => "User level 4",
	...
	"add-title49" => "Consolidation Status",
	"add-title20" => "Delivery Time",
	"add-title21" => "1 - 3 Business Days",
	"add-title22" => "Service Mode",
	"tariff_no_configured" => "No tariffs configured for the selected route/mode",
	"add-tariff-provider" => "Tariff Provider",
	...
	"tools-statuscourier21" => "Edit statuses",
	...
	"tools-category5" => "Return to Dashboard logistics service",
	...
	"sender_search_title" => "Sender",
	"sender_search_address_title" => "Sender Address",
	"recipient_search_title" => "Recipient",
	"recipient_search_address_title" => "Recipient Address",
	...
	"report-general037" => "comebackhere",
	"report-general038" => "View Customer",
	...
	"asingreportexcell1" => "Destination Phone",
	"asingreportexcell2" => "Destination Address",
    "connect_store" => "Connect your Store",
    "platform" => "Platform",
    "new" => "New",

	"courier_table_qty" => "Qty",
	"courier_table_remove" => "Remove",
	"courier_weight_total" => "Total Real Weight",
	"courier_vol_weight_total" => "Total Volumetric Weight",
	"courier_attached_files_count" => "Attached Files",
	"courier_select_country_code" => "Select the country code",

	"rolesp1" => "Roles List",
	"rolesp2" => "Search User Role",
	"rolesp3" => "Role Name",
	"rolesp4" => "Role Description",
	"rolesp5" => "Status",
	"rolesp6" => "Creation Date",
	"rolesp7" => "Edit Role Name",
	"rolesp8" => "Delete Role",
	"rolesp9" => "Role Names",
	"rolesp10" => "Add New Role",
	"rolesp11" => "Active",
	"rolesp12" => "Inactive",
	"rolesp13" => "New role description",
	"rolesp14" => "Add New ROLE",
	"rolesp15" => "Back to roles list",
	"rolesp16" => "Enter Role Name",
	"rolesp17" => "Enter Role Description",
	"rolesp18" => "Role name is already in use",
	"rolesp19" => "The role you want to delete is associated with a user account",
	"rolesp20" => "Edit Role",
	"rolesp21" => "Update Role",
	"rolesp22" => "Role Status",
	"rolesp23" => "Modules List",
	"rolesp24" => "Assign Permissions",
	"rolesp25" => "Module permission assignment list",
	"rolesp26" => "Search module permission assignment",
	"rolesp27" => "Assigned module name",
	"rolesp28" => "Role Status",
	"rolesp29" => "Assign new permissions to modules",
	"rolesp30" => "Assign new permission to modules",
	"rolesp31" => "Select a user level to assign module permissions",
	"rolesp32" => "Add Role Name",
	"rolesp33" => "Add Role Description",
	"rolesp34" => "Required Fields:",
	"rolesp35" => "Please complete the following fields:",
	"rolesp36" => "Please wait while we save the role.",
	"rolesp37" => "Role has been saved successfully.",
	"rolesp38" => "Collapse",
	"rolesp39" => "Expand",
	"rolesp40" => "Permissions Settings",
	"rolesp41" => "+ Add New Role",
	"rolesp42" => "Select User Level",
	"rolesp43" => "Select All",
	"rolesp44" => "Create Permissions",
	"rolesp45" => "Back to permissions list",
	"rolesp46" => "Permissions",
	"rolesp47" => "Add New Client",
	"rolesp48" => "Module permissions",
	"rolesp49" => "Module/Sub-Module",
	"rolesp50" => "Description",
	"rolesp51" => "Update Modules",
	"rolesp52" => "Back to modules list",

	"asingmodule1" => "System Modules List",
	"asingmodule2" => "Assign user level permission",
	"asingmodule3" => "Search System Modules",
	"asingmodule4" => "Edit System Modules",
	"asingmodule5" => "Creation Date",
	"asingmodule6" => "Error updating module action with ID",
	"asingmodule7" => "Module and its actions have been updated successfully.",
	"asingmodule8" => "Error updating module.",
	"asingmodule9" => "Module Features",
	"asingmodule10" => "Module Description",
	"asingmodule11" => "Creation Date",
	"asingmodule12" => "Actions",
	"asingmodule13" => "Access Control Level",
	"asingmodule14" => "Please complete the role name and description.",
	"asingmodule15" => "Missing Fields",
	"asingmodule16" => "No Permissions",
	"asingmodule17" => "You must select at least one permission.",
	"asingmodule18" => "Role and permissions have been saved successfully.",
	"asingmodule19" => "Edit permissions configuration",
	"asingmodule20" => "Update Permissions",

	"asingmoduleexcell1" => "Import EXCEL",
	"asingmoduleexcell2" => "Import Excel or CSV file",
	"courier_import_help" => "Download the template and the ID reference. Columns: sender_id, sender_address_id, recipient_id, recipient_address_id, order_service_options, quantity, weight, length, width, height, description, declared_value, distance_miles, manual_tariff, price_lb, country_origin_id, country_destination_id.",
	"courier_import_preview" => "Preview - Review and edit before creating",
	"courier_import_rows" => "Rows",
	"courier_import_with_error" => "With error",
	"courier_import_valid" => "Valid",
	"courier_import_delete_row" => "Remove",
	"courier_import_sender" => "Sender",
	"courier_import_sender_address" => "Sender address",
	"courier_import_recipient" => "Recipient",
	"courier_import_recipient_address" => "Recipient address",
	"courier_import_service_mode" => "Service mode",
	"courier_import_chargeable_weight" => "Chargeable weight",
	"courier_import_price_base" => "Base price",
	"courier_import_cargo_miles" => "Cargo miles",
	"courier_import_total_tariff" => "Total tariff",
	"courier_import_error_col" => "Error",
	"courier_import_select_file" => "Select a file.",
	"courier_import_no_data" => "The file contains no valid rows or only headers.",
	"courier_import_cannot_create" => "Some rows have automatic tariff but no calculated tariff or have errors. Fix or set manual tariff.",
	"courier_import_no_valid_rows" => "No rows without errors to create.",
	"courier_import_err_sender_id" => "Missing sender_id",
	"courier_import_err_sender_address" => "Missing sender_address_id",
	"courier_import_err_recipient_id" => "Missing recipient_id",
	"courier_import_err_recipient_address" => "Missing recipient_address_id",
	"courier_import_err_service_options" => "Missing order_service_options (service mode)",
	"courier_import_err_weight" => "Weight must be greater than 0",
	"courier_import_err_weight_min" => "Weight must be at least 1 lb.",
	"courier_import_err_sender_not_found" => "sender_id does not exist",
	"courier_import_err_sender_address_not_found" => "sender_address_id does not exist",
	"courier_import_err_recipient_not_found" => "recipient_id does not exist",
	"courier_import_err_recipient_address_not_found" => "recipient_address_id does not exist",
	"courier_import_err_category_invalid" => "order_service_options does not match cdb_category",
	"courier_import_valid_options" => "Valid options",
	"courier_import_download_reference" => "Download ID reference",
	"courier_import_country_origin" => "Country origin",
	"courier_import_country_destination" => "Country destination",
	"courier_import_success_redirect" => "You will be redirected to the list of shipments.",
	"courier_import_err_incomplete" => "Incomplete data.",
	"courier_import_btn_back" => "Back",
	"courier_import_btn_create" => "Create shipments",
	"courier_import_declared_value" => "Declared value",
	"courier_import_distance_miles" => "Distance (miles)",
	"courier_import_manual_tariff" => "Manual tariff",
	"courier_import_price_lb" => "Price/lb",
	"courier_import_process_done" => "Process completed",
	"courier_import_created" => "Created",
	"courier_import_failed" => "Failed",
	"courier_import_conn_error" => "Connection error.",
	"courier_import_server_error" => "Invalid server response.",
	"courier_import_file_label" => "File",
	"courier_import_invalid_option" => " (invalid)",

	"metaseo1" => "SEO Tags",
	"metaseo2" => "Configure SEO meta tags",
	"metaseo3" => "Meta Description",
	"metaseo4" => "Short and attractive description",
	"metaseo5" => "Keywords",
	"metaseo6" => "keyword1, keyword2",
	"metaseo7" => "Meta Open Graph (for social networks like Facebook)",
	"metaseo8" => "Open Graph Title",
	"metaseo9" => "Title for social sharing",
	"metaseo10" => "Open Graph Description",
	"metaseo11" => "Short description for social networks",
	"metaseo12" => "Open Graph Type",
	"metaseo13" => "Content type (e.g. website)",
	"metaseo14" => "Open Graph URL",
	"metaseo15" => "https://www.yoursite.com/your-page",
	"metaseo16" => "Open Graph Image",
	"metaseo17" => "https://www.yoursite.com/image.jpg",
	"metaseo18" => "Save SEO Settings",
	"metaseo19" => "Meta Description (for search results)",
	"metaseo20" => "Meta description is required.",
	"metaseo21" => "Open Graph title is required.",
	"metaseo22" => "Open Graph description is required.",
	"metaseo23" => "Open Graph type is required.",
	"metaseo24" => "Open Graph URL is required.",
	"metaseo25" => "Open Graph image is required.",
	"metaseo26" => "Required field",

	// Role names (100% language – used in roles/users UI)
	"role_administrator_desc" => "Full permissions without sensitive configuration",
    ...
    'validate_notification_type_error' => 'No known notification type',
    'validate_user_id_error' => 'No known user for message',
    'validate_subject_error' => 'No known subject for message',
    'validate_message_error' => 'No known message for push notification',

    'invoice_header' => 'Invoice Push Notification',
    'shipment_date_range_label' => 'Date of Shipment (Range)',
    'pickup_date_label' => 'Select Pickup Date',
    'shipment_status_label' => 'Shipment Status',
    'send_invoice_notification' => 'Send Invoice Notification',
    'export_invoice' => 'Export Invoice',
    
    'shipment_date_from' => 'Shipment Date: From',
    'shipment_date_to' => 'Shipment Date: To',
    'shipment_pickup_date' => 'Date of Pickup',
    'sender_package' => 'Select Package(s)',
    'add_invoice_row' => 'Add Invoice Row',
    
    'commercial_inv' => 'Commercial Invoice',
    'left-menu-sidebar-67' => 'Commercial Invoice',
    
    'sender_not_account_holder' => 'Sender is not account holder',
    ...
    'prealert_fetch_error' => 'Unable to fetch details right now.',
    'prealert_fetch_not_configured' => 'Tracking lookup is not configured yet.',
    'prealert_fetch_no_data' => 'No product details were found for this tracking number.',
    'prealert_fetch_invalid_courier' => 'Selected courier is invalid.',
    'prealert_fetch_unsupported' => 'Tracking lookup is not available for this courier.',
    'prealert_settings_title' => 'Smart Prealert Tracking',
    'prealert_settings_help' => 'Configure the tracking lookup endpoint used to auto-fill prealert details.',
    'prealert_settings_enabled' => 'Enable lookup',
    'prealert_settings_provider' => 'Provider',
    'prealert_settings_provider_none' => 'Disabled',
    'prealert_settings_provider_custom' => 'Custom HTTP',
    'prealert_settings_base_url' => 'Tracking API URL',
